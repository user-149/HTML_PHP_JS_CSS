...
<html>
	...
	<body>
		...
		<ul class="navbar">
			...
			<li>
				<div class="dropdown">
					<button class="dropbtn btn-scondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
						Master Data
						<i class="fa fa-caret-down">
						</i>
					</button>
					<div class="dropdown-content">
						<a href="/training/compounents/ListPelatihan.php">
							List Pelatihan
						</a>
						<a href="/training/compounents/ListPeserta.php">
							List Peserta
						</a>
						<a href="/training/compounents/ListPengajar.php">
							List Pengajar
						</a>
					</div>
				</div>
		...
		<p>
			...
			to the top when you reach its scroll position.
		</p>
		<p>
			<strong>
				Note:
			</strong>
			Internet Explorer do not support sticky positioning and Safari requires a -webkit- prefix.
		</p>
		<p>
